...
void AnimatedSprite::addAnimation(int frames, int x, int y, std::string name, int width, int height, Vector2D offset) {
	...
	this->_offsets.insert(std::pair<std::string, Vector2D>(name, offset));
}
